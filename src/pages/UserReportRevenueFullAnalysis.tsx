...
export default function UserReportRevenueFullAnalysis() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-foreground leading-relaxed text-justify max-w-4xl mt-2">
                  {userReport.idea_title} - Complete monetization strategy and revenue model
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Revenue Model Table */}
        {(() => {
          const sections = parseRevenueModel(userReport.revenue_plan);
