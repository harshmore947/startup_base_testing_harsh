...
export default function RevenueFullAnalysisDynamic() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b bg-background/95 backdrop-blur sticky top-0 z-50">
        <div className="container max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-xl font-semibold">Revenue Model</h1>
            <div></div>
          </div>
        </div>
      </header>
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-foreground leading-relaxed text-justify max-w-4xl mt-2">
                  {idea.title} - Complete monetization strategy and revenue model
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Revenue Model Table */}
        {(() => {
          const sections = parseRevenueModel(idea.revenue_model);
