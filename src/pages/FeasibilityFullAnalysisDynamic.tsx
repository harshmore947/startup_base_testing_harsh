...
export default function FeasibilityFullAnalysisDynamic() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-foreground leading-relaxed text-justify max-w-4xl mt-2">
                  {idea.title} - Technical and business feasibility assessment
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Analysis Content */}
        <AnalysisContent 
          content={idea.feasibility_reasoning_full_analysis} 
          score={idea.feasibilty_score}
        />
      </div>
    </div>
  );
