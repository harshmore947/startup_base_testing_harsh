...
export default function WhyNowFullAnalysis() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-foreground leading-relaxed text-justify max-w-4xl mt-2">
                  {ideaOfTheDay.title} - Understanding why this is the perfect moment to launch
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Analysis Content */}
        <AnalysisContent 
          content={ideaOfTheDay.why_now_full_analysis} 
          score={ideaOfTheDay.timing_score}
        />

        {/* News Articles */}
        {ideaOfTheDay.news_data && (
          <Card className="mt-8">
            <CardHeader>
