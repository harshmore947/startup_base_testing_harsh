...
import { InteractiveOpportunityCards } from '@/components/InteractiveOpportunityCards';
import { useNavigate } from 'react-router-dom';
import { useIdeaOfTheDay } from '@/hooks/useIdeaOfTheDay';

export default function OpportunityFullAnalysis() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-foreground leading-relaxed text-justify max-w-4xl mt-2">
                  {ideaOfTheDay.title} - Comprehensive analysis of market conditions and growth potential
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Analysis Content */}
        <InteractiveOpportunityCards 
          content={ideaOfTheDay.overall_oppurtunity_full_analysis} 
          score={ideaOfTheDay.overall_opportunity_score}
        />
      </div>
    </div>
  );
